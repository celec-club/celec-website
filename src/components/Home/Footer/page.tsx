        ...
        <footer className="relative w-full border-t border-gray-200 bg-white text-gray-700 py-12">
            ...
            <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row justify-between gap-12">
                ...
                <div className="flex flex-col sm:flex-row items-center lg:items-start gap-4 sm:gap-6 text-center lg:text-left">
                    ...
                    />
                    <div>
                        <h3 className="text-2xl font-bold tracking-tight py-3 text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-purple-600">
                            CELEC CLUB
                        </h3>
                        <p className="text-gray-500 text-sm max-w-xs hidden sm:block">
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={link.label}>
                                    <a
                                        href={link.href}
                                        className="hover:text-blue-600 transition-all duration-300 hover:pl-2 flex items-center group"
                                    >
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={event}>
                                    <a
                                        href="#events"
                                        className="hover:text-purple-600 transition-all duration-300 hover:pl-2 flex items-center group"
                                    >
                        ...
                        <ul className="space-y-4">
                            <li>
                                <a
                                    ...
                                    className="hover:text-pink-600 transition-colors duration-300 flex items-center gap-2 group"
                                >
            ...
            <div className="mt-10 border-t border-gray-200 pt-6">
                <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-3 text-gray-500">
